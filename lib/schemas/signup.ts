...
export const signUpSchema = z.object({
  ...
  country: z.string().min(1, '국가를 선택해주세요').length(2, '국가 코드는 2글자여야 합니다'),

  investmentGoals: z.enum(investmentGoalValues, {
    message: '올바른 투자 목표를 선택해주세요',
  }),

  riskTolerance: z.enum(riskToleranceValues, {
    message: '올바른 위험 감수 수준을 선택해주세요',
  }),

  preferredIndustry: z.enum(preferredIndustryValues, {
